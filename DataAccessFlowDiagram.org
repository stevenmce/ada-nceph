...
Your assistance is needed to shape the availability of births, deaths and marriages data in Australia

The Registries of Births, Deaths and Marriages (RBDMs) invite you to complete the 2012 registry data users' survey. https://www.surveymonkey.com/s/registrydatasurvey 

The results of this survey will help the Registries to understand your workplace's current and ongoing data requirements and to define a new set of processes for those interested in accessing registry data.

We are looking for independent researchers and agency work units to complete the survey. In the case of agency work units, we ask that you provide one coordinated response on behalf of all of the researchers in your work unit.

Please help us to gain a wide range of responses by forwarding this email to anyone you know who is likely to require registry data in the future.

Access to the survey will be available until the 8th of November 2012. Please ensure you complete the survey on or before this date.

Thank you for your assistance. If you have any questions about the survey, contact the Queensland RBDM by email.
 

Regards,
National Data Management Framework Project Team
...
http://policies.anu.edu.au/policies/information_infrastructure_security/policy The University Information Technology Services Rules, Discipline Rules and relevant industrial awards contain provisions that will be used to deal with users in breach of this policy.
...
yes Full date of occurence (e.g. 26/11/1974)	
Part date of occurence (e.g. November 1974)	
yes Reference year	
Registration date	
yes Usual residence SA2 code	
yes Usual residence partial address data items (e.g. postcode, region, state)	
yes Residency period	
yes Place of occurence	
yes Place of birth (e.g. country, state or territory)	
yes Age	
yes Gender	
Certifer	
yes Underlying cause of death	
yes Axis counts (to determine the number of records attached to the underlying cause of death)	
yes Martial status	
Maiden name (if applicable)	
Alias names	
yes Date of disposal	
yes Place of disposal (institution)	
yes Multiple cause of death codes	
Other (please specify)
**** Q6. How do you and staff in your work unit intend to use mortality data? Please select all that apply from the list below. 
Research using RBDM data to produce aggregate reports.
Research using RBDM and user's non-identifiable data (e.g. cross referencing with other aggregate data) to produce aggregate reports.
Research for input into policy development.
Research for monitoring policy outcomes.
Research for policy evaluation.
**** Q7. How do you or staff in your work unit intend to output the findings of mortality data? Please select all that apply from the list below.
Aggregated reports available in public domain (including reports, submissions, published data tables).
Other = Peer reviewed journal papers

**** Q8. How often would your work unit require the mortality data to be provided by the registry? If you have need for multiple data sets with different provision requirements, please select all that apply from the list below.   
Ongoing data required annually

**** Q9. What are your work unit’s mortality data retention requirements? If you have a need for multiple data sets with different retention requirements, please select all that apply.   
There is an ongoing requirement for use in longitudinal data set/ indefinite retention.
